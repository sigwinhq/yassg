    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $treeBuilder->getRootNode()
            ->children()
                ...
                ->end()
                ->scalarNode('social_image_template')
                    ->defaultNull()
                    ->info('Path to the default Twig template for social images')
                ->end()
                ->arrayNode('variables')
                    ->scalarPrototype()
                    ->end()
                        ...
                        ->children()
                            ...
                            ->arrayNode('options')
                                ->children()
                                    ...
                                    ->scalarNode('social_image_template')
                                        ->defaultNull()
                                        ->info('Path to the Twig template for social images for this route')
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
